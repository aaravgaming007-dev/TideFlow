...
import com.aaravsharma.tideflow.about.AboutContributor
import com.aaravsharma.tideflow.about.AboutContributorCollection
import com.aaravsharma.tideflow.about.AboutDependencyLicense
import com.aaravsharma.tideflow.about.AboutDependencyLicenseCollection
import com.aaravsharma.tideflow.about.AboutTranslationContributor
import com.aaravsharma.tideflow.about.AboutTranslationContributorCollection
import com.aaravsharma.tideflow.about.FetchAboutContributorsUseCase
import com.aaravsharma.tideflow.about.FetchAboutDependencyLicensesUseCase
import com.aaravsharma.tideflow.about.FetchAboutTranslationContributorsUseCase
...
class AboutViewModel
    ...
    constructor(
                ...
                primaryLinks =
                    AboutLinkCollection.of(
                        AboutLinkUiModel(
                            ...
                            url = "https://github.com/aaravgaming007-dev/TideFlow/",
                        ),
                        AboutLinkUiModel(
                            id = "website",
                            iconResId = R.drawable.website,
                            labelResId = R.string.about_content_desc_website,
                            url = "https://aaravsharma.pages.dev",
                        ),
                        AboutLinkUiModel(
                            id = "instagram",
                            iconResId = R.drawable.instagram,
                            labelResId = R.string.about_content_desc_discord,
                            url = "https://instagram.com/aarav_sharma_sui",
                        ),
                        AboutLinkUiModel(
                            id = "donate",
                            iconResId = R.drawable.coffee,
                            labelResId = R.string.about_content_desc_donate,
                            url = "upi://pay?pa=ghanshyamsharma.nlu@okicici&pn=AARAV%20SHARMA&cu=INR",
                        ),
                    ),
                leadDeveloper =
                    TeamMember(
                        avatarUrl = "https://avatars.githubusercontent.com/aaravgaming007-dev",
                        name = "AARAV SHARMA",
                        ...
                        links =
                            AboutLinkCollection.of(
                                AboutLinkUiModel(
                                    ...
                                    iconResId = R.drawable.github,
                                    labelResId = R.string.about_content_desc_github,
                                    url = "https://github.com/aaravgaming007-dev",
                                ),
                                AboutLinkUiModel(
                                    id = "website",
                                    iconResId = R.drawable.website,
        ...
        private companion object {
            ...
            const val ContributorsReadMoreUrl = "https://github.com/aaravgaming007-dev/TideFlow/graphs/contributors"
        }
    }
