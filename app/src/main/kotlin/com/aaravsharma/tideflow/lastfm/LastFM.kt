...
package com.aaravsharma.tideflow.lastfm
...
import com.aaravsharma.tideflow.lastfm.models.LastFmError
import com.aaravsharma.tideflow.lastfm.models.TokenResponse
import java.net.URI
...
object LastFM {
    ...
    private fun HttpRequestBuilder.lastfmParams(
        ...
        headers.append(HttpHeaders.UserAgent, "NomaTune (https://github.com/aaravgaming007-dev/TideFlow/)")
        val paramsForSig =
            mutableMapOf(
                "method" to method,
                "api_key" to apiKey,
