...
import com.aaravsharma.tideflow.App
import com.aaravsharma.tideflow.constants.DailyNightlyReleasesEtagKey
import com.aaravsharma.tideflow.constants.DailyNightlyReleasesFingerprintKey
import com.aaravsharma.tideflow.constants.DailyNightlyReleasesJsonKey
import com.aaravsharma.tideflow.constants.DailyNightlyReleasesLastCheckedAtKey
import com.aaravsharma.tideflow.constants.GitHubReleasesEtagKey
import com.aaravsharma.tideflow.constants.GitHubReleasesFingerprintKey
...
object Updater {
    ...
    suspend fun getCommitHistory(count: Int = 20, branch: String = "dev"): Result<List<GitCommit>> =
        runCatching {
            ...
            val response =
                client.get("https://api.github.com/repos/aaravgaming007-dev/TideFlow/commits?sha=$branch&per_page=$count")
                    .bodyAsText()
