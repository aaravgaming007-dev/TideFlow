...
import com.aaravsharma.tideflow.constants.QueueEditLockKey
...
import com.aaravsharma.tideflow.ui.component.MediaMetadataListItem
import com.aaravsharma.tideflow.ui.component.TextFieldDialog
import com.aaravsharma.tideflow.ui.menu.AddToPlaylistDialog
...
fun Queue(
    ...
    val togetherForcesLock =
        togetherSessionState is com.aaravsharma.tideflow.together.TogetherSessionState.Joined &&
            (togetherSessionState as com.aaravsharma.tideflow.together.TogetherSessionState.Joined).role is com.aaravsharma.tideflow.together.TogetherRole.Guest
                                                    ...
                                                    onClick = {
                                                        if (selection) {
                                                            ...
                                                            if (index == currentWindowIndex) {
                                                                ...
                                                                val joined =
                                                                    togetherSessionState as? com.aaravsharma.tideflow.together.TogetherSessionState.Joined
                                                                val isGuest = joined?.role is com.aaravsharma.tideflow.together.TogetherRole.Guest
                                                                if (isGuest) {
